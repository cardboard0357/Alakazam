...
execute if score @s quarry_laser_limit matches 600.. run playsound minecraft:block.respawn_anchor.charge block @a[distance=0..10] ~ ~ ~ 1 0.7
...
execute unless block ~ ~ ~ #air run playsound minecraft:block.respawn_anchor.charge block @a[distance=0..10] ~ ~ ~ 1 0.7
